        ...
        function updateBarWithDefColor(id, type) {
            if (id == 'modules_color_second_section_main') {
                $('.s123-module-percentage:not(.bg-primary).layout-1').each(function() {
                    var $this = $(this);
                    let sectionMainColor = type != 'input' ? getComputedStyle(document.documentElement).getPropertyValue('--modules_color_second_section_main') : topWindow.$('#modules_color_second_section_main').val();
                ...
                $('.inside_page .bg-primary.s123-module-percentage.layout-1').each(function() {
                    var $this = $(this);
                    let sectionMainColor = type != 'input' ? getComputedStyle(document.documentElement).getPropertyValue('--inside_modules_color_section_box_main') : topWindow.$('#inside_modules_color_section_box_main').val();
                    updateBarColor($this, sectionMainColor);
                });
            }
        }
